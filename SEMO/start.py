...
async def welcome(client: Client, message):
   try:
    ...
    if message.new_chat_members[0].username == "IQ7amo":
      try:
...
async def bot_kicked(client: Client, message):
    ...
    if message.left_chat_member.id == bot.id:
         logger = await get_dev(bot_username)
         chat_id = message.chat.id
         await client.send_photo(logger, photo=random.choice(joinandleft), caption=f"**● ꒐ بۆت باندکرا 💎.**\n**● ꒐ ناوی گرووپ : {message.chat.title} 💎.**\n**● ꒐ ئایدی گرووپ : `{message.chat.id}` 💎.**\n**● ꒐ دەرکرا لەلایەن : {message.from_user.mention} 💎.**", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(f"نوێکارییەکانی ئەلینا 🍻", url=f"https://t.me/MGIMT")]]))
...
async def llink(client: Client, message: Message):
    if not message.from_user.username in ["IQ7amo"]:
      return
...
async def sssora(client, message):
  ...
  await message.reply_photo(photo=photo, caption="**♪ 𝑱𝒐𝒊𝒏 ➧ @EHS4SS 💎.**",
  reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def voece(client, message):
  ...
  await message.reply_audio(audio=audio, caption="**♪ 𝑱𝒐𝒊𝒏 ➧ @IQMUC 💎.**",
  reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def videoo(client, message):
  ...
  await message.reply_video(video=video, caption="**♪ 𝑱𝒐𝒊𝒏 ➧ @EHS4SS 💎.**",
  reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def qurann(client, message):
  ...
  await message.reply_video(video=video, caption="**♪ 𝑱𝒐𝒊𝒏 ➧ @IQQUR 💎.**",
  reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def qurann2(client, message):
  ...
  await message.reply_audio(audio=audio, caption="**♪ 𝑱𝒐𝒊𝒏 ➧ @IQQUR 💎.**",
  reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
